...
remove_letter = str(input('Specify some word\'s letter to be removed:'))
corrected_sentence = (test_word.replace(remove_letter,''))
print(f'Check what is done: {corrected_sentence}')
#Home task_2
string_initial_state = str(input('Type some sentence:'))
...
#Home task_3
initial_string = str(input('Type some sentence and wait for the magic:'))
finished_string = (initial_string[::-1])
print(f'Magic is done: {finished_string}')
#Home task_4
string_1 = str(input('Enter any sentence you want:'))
string_2 = str(input('Enter one more sentence:'))
is_the_same = (string_1 == string_2)
print(f'These values are identical: {is_the_same}')
#Home task_5
repeat_string = str((input('Enter some letters:')))
